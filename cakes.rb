class Cake
    ...
    def self.all
        [
            Cake.new("Turon", "A traditional Filipino dessert brought into cake format. Sponge cake with bourbon & brown sugar bananas, agave jackfruit. Topped off with glazed and remixed wrapping paper.", "59.99", '/images/turoncake.jpg'),
